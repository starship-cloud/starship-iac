# The runstarship/starship-base is created by docker-base/Dockerfile.
FROM ghcr.io/runstarship/starship-base:2021.08.31

# install terraform binaries
ENV DEFAULT_TERRAFORM_VERSION=1.0.11

# In the official starship image we only have the latest of each Terraform version.
